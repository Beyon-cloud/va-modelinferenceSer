...
class EnvKeys:
    ...
    CONSUL_USE_HTTPS= "CONSUL_USE_HTTPS"
    CONSUL_SERVICE_ENABLED_YN= "CONSUL_SERVICE_ENABLED_YN"
    CONSUL_HOST= "CONSUL_HOST"
    CONSUL_PORT= "CONSUL_PORT"
    CONSUL_SERVICE_WATCHER_TIMEOUT= "CONSUL_SERVICE_WATCHER_TIMEOUT"
    CONSUL_SERVICE_WATCHER_INTERVAL= "CONSUL_SERVICE_WATCHER_INTERVAL"
    CONSUL_SERVICE_GRPC_PREFER= "CONSUL_SERVICE_GRPC_PREFER"
